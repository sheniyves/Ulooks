          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 sm:gap-6 lg:gap-10 xl:gap-16 min-h-screen">
            ...
            /> */}
              <div className="flex items-center justify-center flex-col">
                <h2 className=" px-6 lg:px-0 text-transparent bg-darkPurple mt-10 bg-clip-text font-fashion text-[1.75rem] font-bold flex items-center gap-4">
                  Check your mail
                </h2>
                <p className="px-6 lg:px-0 text-darkPurple font-medium text-[1rem] mt-4 text-center">
                  We have sent a 6 digit OTP to your email, to confirm email,
              ...
              <div className="text-center flex items-center gap-2 justify-center">
                <button
                  ...
                  className={` font-semibold cursor-pointer ${
                    isDisabled ? "text-gray cursor-not-allowed" : "text-purple"
                  }`}
                  onClick={resendOTP}
                >
                  Resend Code
