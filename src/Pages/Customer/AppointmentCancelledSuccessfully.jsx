...
const AppointmentCancelledSuccessfully = () => {
  return (
    <div className="bg-[#f4e2fe]  pb-[8rem] lg:pb-20">
      <PageTransition>
        <ConatinerWidth>
          {/* <img
          ...
          /> */}
          <div className=" flex items-center justify-center flex-col px-4 md:w-full pt-[10%]">
            <motion.img
            ...
            <h1 className="text-purple text-center leading-[3.8rem] md:leading-[4rem] text-[2.8rem] md:text-[3.78rem] font-bold font-fashion ">
...
export default AppointmentCancelledSuccessfully;
