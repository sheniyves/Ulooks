...
const ServiceProviderInspiration = () => {
  ...
  return (
    <div className=" mt-0 lg:mt-6 min-h-screen relative">
      <ConatinerWidth>
        ...
        <UploadInspo uploadRef={uploadRef} uploadRefDialog={uploadRefDialog} nav={"/serviceProviderWebApp/createPost"} />
...
export default ServiceProviderInspiration;
